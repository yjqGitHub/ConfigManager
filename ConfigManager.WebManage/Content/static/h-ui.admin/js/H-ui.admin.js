...
function RefreshCurrent() {
    ...
    var currentTab = topWindow.find("#min_title_list li.active"),
        iframe_box = topWindow.find("#iframe_box");
    var index = currentTab && currentTab.index();
    var currentFrame = iframe_box.find(".show_iframe").hide().eq(index).show().find("iframe");
