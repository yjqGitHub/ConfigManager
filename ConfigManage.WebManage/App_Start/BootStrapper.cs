    ...
    public static class BootStrapper
    {
        public static void Install()
        {
            ...
            ContainerManager.UseAutofacContainer(builder)
                            ...
                            .RegisterAssemblyTypes(userApplicationAssembly, new Type[] { typeof(BizIntercept) }, m => m.Namespace != null && m.Namespace.StartsWith("ConfigManager.Application.Implement") && m.Name.EndsWith("Application"), lifeStyle: LifeStyle.PerLifetimeScope)
