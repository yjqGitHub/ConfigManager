namespace JQ.Dependency.Intercept
{
    ...
    public static class UseInterceptConfigManageExtension
    {
        ...
        /// <param name="configuration"></param>
        /// <returns></returns>
        public static ContainerManager UseBizIntercept(this ContainerManager configuration)
        {
            configuration.RegisterType(typeof(BizIntercept), lifeStyle: LifeStyle.Transient);
            return configuration;
        }
    }
}