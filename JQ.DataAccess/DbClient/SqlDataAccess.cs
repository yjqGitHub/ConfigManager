...
namespace JQ.DataAccess.DbClient
{
    ...
    public sealed partial class SqlDataAccess : BaseDataAccess, IDataAccess
    {
        ...
        public T QuerySingleOrDefault<T>(SqlQuery query)
        {
            ...
            return SqlMonitorUtil.Monitor(query, () =>
            {
                return _conn.QuerySingleOrDefault<T>(query.CommandText, query.ParaItems, Tran, query.CommandTimeout, query.CommandType);
            }, dbType: DatabaseTyoe.ToString());
        }
        ...
        public async Task<T> QuerySingleOrDefaultAsync<T>(SqlQuery query)
        {
            ...
            return await SqlMonitorUtil.MonitorAsync(query, async () =>
            {
                return await _conn.QuerySingleOrDefaultAsync<T>(query.CommandText, query.ParaItems, Tran, query.CommandTimeout, query.CommandType);
            }, dbType: DatabaseTyoe.ToString());
        }
