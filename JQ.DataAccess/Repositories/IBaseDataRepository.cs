...
namespace JQ.DataAccess.Repositories
{
    ...
    public interface IBaseDataRepository<T> where T : class, new()
    {
        ...
        void InsertMany(List<T> infoList, string[] ignoreFields = null, bool isIdentity = true);
        ...
        /// <param name="isIdentity">是否自增</param>
        /// <returns></returns>
        Task InsertManyAsync(List<T> infoList, string[] ignoreFields = null, bool isIdentity = true);
        ...
        object InsertOne(T info, string[] ignoreFields = null, bool isIdentity = true);
        ...
        /// <param name="isIdentity">是否自增</param>
        /// <returns>如果是自增则返回自增值，不是返回新增行数</returns>
        Task<object> InsertOneAsync(T info, string[] ignoreFields = null, bool isIdentity = true);
